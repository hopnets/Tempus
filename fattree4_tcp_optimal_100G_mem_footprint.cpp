...
int main() {
    ...
    const char* m_commands[command_num] = { 
        "julia --project=. src/Tempus.jl fattree4_empiric_random_empiric_tcp_100G.json base",
        "julia --project=. src/Tempus.jl fattree4_empiric_random_empiric_tcp_100G.json paths",
        "julia --project=. src/Tempus.jl fattree4_empiric_random_empiric_tcp_100G.json ecs",
        "julia --project=. src/Tempus.jl fattree4_empiric_random_empiric_tcp_100G.json optimal" 
    };
    const char* outfile_name[command_num] = { 
        "./tempus_out/fattree4_empiric_random_empiric_tcp_base_mem_footprint.txt", 
        "./tempus_out/fattree4_empiric_random_empiric_tcp_paths_mem_footprint.txt", 
        "./tempus_out/fattree4_empiric_random_empiric_tcp_ecs_mem_footprint.txt", 
        "./tempus_out/fattree4_empiric_random_empiric_tcp_optimal_mem_footprint.txt" 
    };
